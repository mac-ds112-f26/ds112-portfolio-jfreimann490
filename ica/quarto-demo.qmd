...
It is the exact same if the code is not in a code chunk.
...
It gives you what you wanted it to.

- Render. What appears in the html: R code, output, or both?

In the HTML, it gives you the code and the output. 
...
```{r}
#stored four 10s and then summed
four_tens <- rep(10,4)
sum(four_tens)
```
